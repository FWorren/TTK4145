...
func OrderHandler_process_orders(order_from_network chan Client, order_to_network chan Client, status_update_c chan Client, send_lights_c chan Lights, send_del_req_c chan Order, current_floor Order, localIP net.IP) {
